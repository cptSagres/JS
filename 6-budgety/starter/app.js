...
var DOMstring = {
  ...
  return{
    getinput: function(){
      return  {
         type: document.querySelector(DOMstring.inputType).value.substring(0,3), //will be either inc or exp
...
var controller = (function(budgetCtrl,UICtrl){
  ...
  var ctrlAddItem = function(){
      ...
      var updatePercentages = function(){
        //1 caltulcate updatePercentages
        budgetCtrl.calculatePercentages();
        // read percetages from budget controlelr
